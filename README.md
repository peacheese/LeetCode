...
#### [<mark>28</mark>. 实现 strStr()](https://leetcode-cn.com/problems/implement-strstr/)
...
#### [<mark>1719</mark>. 重构一棵树的方案数](https://leetcode-cn.com/problems/number-of-ways-to-reconstruct-a-tree/)
...
2、n = 1(0*)1 return n-2

3、n = 9+ return n+2

4、常规砍一半，加一减一和本身做镜像就可以了
